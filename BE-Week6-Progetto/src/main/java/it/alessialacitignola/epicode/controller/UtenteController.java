...
public class UtenteController {
	...
	public ResponseEntity<List<Utente>> getDispositivi() {
		List<Utente> dispositivi = us.getAll();
	...
	public ResponseEntity<Object> getAll_page(Pageable pageable) {
		Page<Utente> utenti = us.getAllInPage(pageable);
	...
	public ResponseEntity<Object> delete(@PathVariable Integer id) {
		...
		return new ResponseEntity<>(
			String.format("L'Utente con l'id %d è stato eliminato!", id), HttpStatus.OK	
		);
	}
